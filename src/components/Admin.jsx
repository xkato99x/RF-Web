...
const navigation = [
  ...
  { name: "Propiedades", href: "/admin/propiedades", icon: Bars4Icon, current: false },
  { name: "Ultimas ventas", href: "#", icon: ClockIcon, current: false },
];
const teams = [
  { name: "Casas", href: "#", bgColorClass: "bg-indigo-500" },
  { name: "Terrenos", href: "#", bgColorClass: "bg-green-500" },
  { name: "Rentas", href: "#", bgColorClass: "bg-yellow-500" },
];
const projects = [
  {
    id: 1,
    title: "Casas Prioritarias",
    initials: "CP",
    team: "Casas",
    members: [
      {
                    ...
                    <div className="flex flex-1 items-center justify-between truncate rounded-r-md border-t border-r border-b border-gray-200 bg-white">
                      <div className="flex-1 truncate px-4 py-2 text-sm">
                        ...
                        <p className="text-gray-500">
                          {project.totalMembers} Propiedades
                        </p>
                      </div>
                  ...
                  <thead>
                    <tr className="border-t border-gray-200">
                      <th
                        ...
                        scope="col"
                      >
                        <span className="lg:pl-2">Propiedad</span>
                      </th>
                      <th
                        className="border-b border-gray-200 bg-gray-50 px-6 py-3 text-left text-sm font-semibold text-gray-900"
                        scope="col"
