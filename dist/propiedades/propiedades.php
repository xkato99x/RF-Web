...
<head>
  ...
  <link rel="stylesheet" href="/assets/admin.e9782f54.css" />
  <link rel="stylesheet" href="/assets/admin.3c16e859.css" />
  <link rel="stylesheet" href="/assets/propiedades.635be1f6.css" />
...
<body>
  <nav class="navigation astro-ORMZZ5NQ">
    <a href="/" class="navigation__section navigation__logo astro-ORMZZ5NQ">
      <svg viewBox="0 0 24 24" class="logo astro-ORMZZ5NQ" astro-icon="majesticons:home">
        <path fill="currentColor" fill-rule="evenodd" d="M10.698 2.799a2 2 0 0 1 2.604 0l6.336 5.43 2.487 1.99a1 1 0 1 1-1.25 1.562l-.875-.7V19a2 2 0 0 1-2 2h-4v-5a2 2 0 1 0-4 0v5H6a2 2 0 0 1-2-2v-7.92l-.875.7a1 1 0 1 1-1.25-1.56l2.487-1.99 6.336-5.431z" clip-rule="evenodd" />
      </svg>
      <span class="name astro-ORMZZ5NQ"> R&amp;F Inmobiliaria</span>
    </a>
    <div class="navigation__section navigation__links astro-ORMZZ5NQ">
      <a href="/nosotros" class="navigation__link astro-ORMZZ5NQ">
        Nosotros </a><a href="/propiedades" class="navigation__link astro-ORMZZ5NQ">
        Propiedades </a><a href="/contacto" class="navigation__link astro-ORMZZ5NQ">
        Contacto
      </a>
    </div>
    <div class="navigation__section navigation__media astro-ORMZZ5NQ">
      <a href="https://www.facebook.com/" class="astro-ORMZZ5NQ">
        <svg viewBox="0 0 32 32" class="whatsapp astro-ORMZZ5NQ" astro-icon="cib:whatsapp">
          <path fill="currentColor" d="M23.328 19.177c-.401-.203-2.354-1.156-2.719-1.292-.365-.13-.63-.198-.896.203-.26.391-1.026 1.286-1.26 1.547s-.464.281-.859.104c-.401-.203-1.682-.62-3.203-1.984-1.188-1.057-1.979-2.359-2.214-2.76-.234-.396-.026-.62.172-.818.182-.182.401-.458.604-.698.193-.24.255-.401.396-.661.13-.281.063-.5-.036-.698s-.896-2.161-1.229-2.943c-.318-.776-.651-.677-.896-.677-.229-.021-.495-.021-.76-.021s-.698.099-1.063.479c-.365.401-1.396 1.359-1.396 3.297 0 1.943 1.427 3.823 1.625 4.104.203.26 2.807 4.26 6.802 5.979.953.401 1.693.641 2.271.839.953.302 1.823.26 2.51.161.76-.125 2.354-.964 2.688-1.901.339-.943.339-1.724.24-1.901-.099-.182-.359-.281-.76-.458zM16.083 29h-.021c-2.365 0-4.703-.641-6.745-1.839l-.479-.286-5 1.302 1.344-4.865-.323-.5a13.166 13.166 0 0 1-2.021-7.01c0-7.26 5.943-13.182 13.255-13.182 3.542 0 6.865 1.38 9.365 3.88a13.058 13.058 0 0 1 3.88 9.323C29.328 23.078 23.39 29 16.088 29zM27.359 4.599C24.317 1.661 20.317 0 16.062 0 7.286 0 .14 7.115.135 15.859c0 2.792.729 5.516 2.125 7.927L0 32l8.448-2.203a16.13 16.13 0 0 0 7.615 1.932h.005c8.781 0 15.927-7.115 15.932-15.865 0-4.234-1.651-8.219-4.661-11.214z" />
        </svg>
      </a>

      <a href="www.whatsapp.com" class="astro-ORMZZ5NQ">
        <svg viewBox="0 0 256 256" class="whatsapp astro-ORMZZ5NQ" astro-icon="logos:instagram-icon">
  ...
  <h1 class="astro-MGDH35U5">Nuestras Propiedades</h1>
  <main class="astro-MGDH35U5">
    <aside class="filters astro-MGDH35U5">
      ...
      <div class="filters__price astro-MGDH35U5">
    ...
    <div id="productos" class="grid astro-MGDH35U5">
      ...
      <!-- <article class="astro-MGDH35U5">
        ...
        <h2 class="astro-MGDH35U5">Propiedad 1</h2>
        <p class="astro-MGDH35U5">Descripcion de la propiedad</p>
        <p class="astro-MGDH35U5">$ 1.000.000</p>
      </article>
      <article class="astro-MGDH35U5">
        <img src="https://picsum.photos/200/300" alt="imagen de la propiedad" class="astro-MGDH35U5" />
        <h2 class="astro-MGDH35U5">Propiedad 2</h2>
        <p class="astro-MGDH35U5">Descripcion de la propiedad</p>
        <p class="astro-MGDH35U5">$ 1.000.000</p>
      </article>
      <article class="astro-MGDH35U5">
        <img src="https://picsum.photos/200/300" alt="imagen de la propiedad" class="astro-MGDH35U5" />
        <h2 class="astro-MGDH35U5">Propiedad 3</h2>
        <p class="astro-MGDH35U5">Descripcion de la propiedad</p>
        <p class="astro-MGDH35U5">$ 1.000.000</p>
      </article>
      <article class="astro-MGDH35U5">
        <img src="https://picsum.photos/200/300" alt="imagen de la propiedad" class="astro-MGDH35U5" />
        <h2 class="astro-MGDH35U5">Propiedad 4</h2>
        <p class="astro-MGDH35U5">Descripcion de la propiedad</p>
        <p class="astro-MGDH35U5">$ 1.000.000</p>
      </article>
      <article class="astro-MGDH35U5">
        <img src="https://picsum.photos/200/300" alt="imagen de la propiedad" class="astro-MGDH35U5" />
        <h2 class="astro-MGDH35U5">Propiedad 5</h2>
        <p class="astro-MGDH35U5">Descripcion de la propiedad</p>
        <p class="astro-MGDH35U5">$ 1.000.000</p>
      </article> -->
    </div>
